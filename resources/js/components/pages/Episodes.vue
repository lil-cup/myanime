        ...
        <div class="container">
            ...
            <div class="episodes__episode">
                <div class="episodes__episode-title" v-if="animeInfo">
                    ...
                    <a href="" class="button"><img src="/images/icons/play.svg">первый эпизод</a>
                    <div class="content">
                        <div>
                        ...
                        <div class="all-text">
                            ...
                            <div class="content__text" v-if="animeInfo.type.description">Тип: <span>{{ animeInfo.type.description }}</span></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="episodes__episodes" v-if="animeInfo">
                <a href="" class="episodes__episodes-episode" v-for="episode in animeInfo.episodes">
